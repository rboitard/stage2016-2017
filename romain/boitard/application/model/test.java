...
public class test extends Application {
  ...
  @Override public void start(Stage stage) {
    ...
    final ScatterChart<Number, Number> lineChart = createChart();
  ...
  private VBox layoutScene(ScatterChart<Number, Number> lineChart, Label cursorCoords) {
  ...
  private Label createCursorGraphCoordsMonitorLabel(ScatterChart<Number, Number> lineChart) {
